...
$tinybrowser['path']['image'] = '/contents/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/contents/'; // Media files location
$tinybrowser['path']['file']  = '/contents/'; // Other files location
...
$tinybrowser['filetype']['media'] = '*.swf, *.flv, *.fla, *.dcr, *.mov, *.qt, *.mpg, *.mp3, *.mp4, *.mpeg, *.avi, *.wmv, *.wm, *.asf, *.asx, *.wmx, *.wvx, *.rm, *.ra, *.ram'; // Media file types
