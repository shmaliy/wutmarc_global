...
*/
		define("TB_BROWSE", "Sfoglia");
		define("TB_GALLERY", "Galleria");
		define("TB_EDIT", "Modifica");
		...
		define("TB_FILENAME", "Nome file");
		define("TB_SIZE", "Dim. (KB)");
		define("TB_DIMENSIONS", "Dimensioni img");
		define("TB_TYPE", "Tipo");
		define("TB_DATE", "Data Modifica");
		define("TB_SEARCH", "Cerca");
		define("TB_FILES", "Files");
		define("TB_BROWSEFILES", "Sfoglia");
		define("TB_DETAILS", "Dettagli");
		...
		define("TB_RESIZE", "Ridimensiona");
		define("TB_UPLOADFILES", "Upload Files");
		define("TB_PROGRESS", "Progresso");
		define("TB_REMOVE", "Rimuovi");
		define("TB_BYTES", "bytes");
		define("TB_WIDTH", "larghezza");
		define("TB_HEIGHT", "altezza");
		define("TB_NONE", "Nessuno");
		...
		define("TB_MSGUPGOOD", "%s files inviati con successo.");
		define("TB_MSGUPBAD", "%s files non sono stati inviati a causa di restrizioni di sicurezza.");
		define("TB_MSGUPDUP", "%s files non sono stati inviati, perche' gia' esistenti - cancella o rinomina i files originali.");
		define("TB_MSGUPFAIL", "Errore nell'invio files - controlla i tuoi permessi per '%s'.");
		define("TB_MSGMAXSIZE", "Non e possibile mettere in coda per l invio, in quanto le dimensioni del file superano il limite di");
		define("TB_TTLMAXSIZE", "Errore dimensioni files");
