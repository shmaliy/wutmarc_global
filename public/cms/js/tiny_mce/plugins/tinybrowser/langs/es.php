...
*/
		...
		define("TB_PAGE", "PГЎgina");
		define("TB_FILENAME", "Nombre de archivo");
		define("TB_SIZE", "TamaГ±o");
		define("TB_DIMENSIONS", "Dimensiones");
		define("TB_TYPE", "Tipo");
		define("TB_DATE", "ModificaciГіn");
		...
		define("TB_MSGRESIZE", "%s imГЎgenes han sido escaladas.");
		define("TB_MSGROTATE", "%s imГЎgenes han sido rotadas.");
		...
		define("TB_MSGUPDUP", "%s archivos no se han subido porque ya existГ­an - por favor, cambia su nombre o bГЎrralos.");
		define("TB_MSGUPFAIL", "No se ha podido subir el archivo. Comprueba los permisos de '%s'.");
		define("TB_MSGMAXSIZE", "no se ha podido poner en cola para subir porque el tamaГ±o es mayor del lГ­mite de");
		define("TB_TTLMAXSIZE", "Error del tamaГ±o de archivo");
		define("TB_DENIED", "Necesitas permiso para ver esta pГЎgina.");
		define("TB_UPDENIED", "Necesitas permisos de subida de archivos para ver esta pГЎgina.");
		define("TB_EDDENIED", "Necesitas permisos de ediciГіn o borrado para ver esta pГЎgina.");
?>