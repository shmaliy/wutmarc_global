...
class menu_db
{
	function __construct(){
		...
		$this->b_nav = array('_self', '_blank', '_parent', '_top');
		$this->info = $this->core->_mod_get_info($this->name);
		$this->mod_tablename = $GLOBALS['cms_config_dbprefix'].'menu';
		...
		$query .= "`link` TEXT CHARACTER SET cp1251 COLLATE cp1251_general_ci NOT NULL, ";
		...
		$query .= "`browser_nav` TEXT CHARACTER SET cp1251 COLLATE cp1251_general_ci NOT NULL, ";
